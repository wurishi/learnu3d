...
public class AttackShooter : MonoBehaviour
{
    ...
    private HorseAttackAdv attackScript;
    ...
    void InstantiateProjectile()
    {
        ...
        attackScript = projectileObj.GetComponent<HorseAttackAdv>();
        RotateToDestination(projectileObj, destination, true);
        projectileObj.GetComponent<Rigidbody>().velocity = transform.forward * attackScript.speed;
    }
    ...
    void InstantiateProjectileAtFirePoint()
    {
        ...
        projectileObj.GetComponent<Rigidbody>().velocity = firePoint.transform.forward * attackScript.speed;
    }
